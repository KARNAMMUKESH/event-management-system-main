...
def runQuery(query):
    ...
    try:
        db = mysql.connector.connect( host='localhost',database='event_mgmt',user='root',password='mukesh@7')
...
def show_logistics():
    ...
    conn = mysql.connector.connect(host='localhost',database='event_mgmt',user='root',password='mukesh@7')
